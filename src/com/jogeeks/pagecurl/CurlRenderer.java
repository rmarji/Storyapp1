...
public class CurlRenderer implements GLSurfaceView.Renderer {
	...
	private void updatePageRects() {
		if (mViewRect.width() == 0 || mViewRect.height() == 0) {
			...
			mPageRectRight.left +=  mMargins.left;
			mPageRectRight.right -= mMargins.right;
			mPageRectRight.top += mMargins.top;
			mPageRectRight.bottom -= mMargins.bottom;
